          ...
          <div className="xl:col-span-1 space-y-6">
            ...
            <div className="bg-slate-800/40 backdrop-blur-sm border border-slate-700/50 rounded-2xl p-6">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <select className="w-full bg-slate-700/50 border border-slate-600/50 text-white rounded-lg px-4 py-3 text-sm">
                ...
                <div className="flex items-center justify-between p-4 bg-slate-700/20 rounded-lg">
                  ...
                  <input
                    type="checkbox"
                    defaultChecked
                    className="w-5 h-5 text-blue-600 bg-slate-700/50 border-slate-600 rounded focus:ring-blue-500"
                  />
                </div>
            ...
            <div className="bg-gradient-to-br from-blue-900/20 to-purple-900/20 border border-blue-700/30 rounded-2xl p-6">
              ...
              <div className="space-y-3">
                <button className="w-full bg-blue-600/20 hover:bg-blue-600/30 border border-blue-500/30 text-blue-400 py-3 px-4 rounded-lg text-sm font-medium transition-all duration-200">
                  📊 View Analytics
                </button>
                <button className="w-full bg-purple-600/20 hover:bg-purple-600/30 border border-purple-500/30 text-purple-400 py-3 px-4 rounded-lg text-sm font-medium transition-all duration-200">
                  📱 Generate QR Code
                </button>
                <button className="w-full bg-green-600/20 hover:bg-green-600/30 border border-green-500/30 text-green-400 py-3 px-4 rounded-lg text-sm font-medium transition-all duration-200">
                  💾 Export Data
                </button>
              </div>
            </div>
