    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center p-5">
      <div className="bg-white/95 p-10 rounded-3xl shadow-2xl text-center text-gray-800 max-w-lg w-full">
        ...
        <h2 className="text-lg text-blue-600 mb-4">
          {isClient ? accessType : "Loading..."}
        </h2>
        <p className="mb-6">
          Scan this QR code with your phone to access the camera interface
        </p>
        ...
        <div className="bg-blue-50 p-5 rounded-lg mb-6 text-left">
          ...
          <div className="space-y-2 text-sm">
            <div className="flex items-start">
              ...
              <span>
                <strong>Step 1:</strong> Scan QR code with your phone camera
              </span>
            </div>
            <div className="flex items-start">
              <span className="text-lg mr-2">📶</span>
              <span>
                <strong>Step 2:</strong> Make sure phone & computer are
                connected
              </span>
            </div>
            <div className="flex items-start">
              <span className="text-lg mr-2">📷</span>
              <span>
                <strong>Step 3:</strong> Allow camera permissions on phone
              </span>
            </div>
            <div className="flex items-start">
              <span className="text-lg mr-2">🔗</span>
              <span>
                <strong>Step 4:</strong> Connect to browser for live detection
              </span>
            </div>
          </div>
        </div>
        ...
        <p className="text-sm mb-6">
          <strong>💡 Alternative:</strong> Manually type the URL above into your
          phone&apos;s browser
        </p>
